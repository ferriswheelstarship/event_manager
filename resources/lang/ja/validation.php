...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'zip' => '郵便番号',
        'address' => '住所',
        'company_profile_id' => '所属施設',
        'serial_number' => '保育士番号',
        'area_name' => '地区名',
        'company_variation' => '設置主体',
        'branch_name' => '支部名',
        'category' => 'こども園類型',
        'kyokai_number' => '協会NO',
        'other_facility_name' => '施設名',
        'other_facility_zip' => '施設所在地 郵便番号',
        'other_facility_address' => '施設所在地 住所',
