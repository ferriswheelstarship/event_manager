      ...
      <div class="contents-section-inner fadeInUp">
        <article class="links-box">
          <header class="links-header">
            <span class="talr">@php echo date('Y.m.d', strtotime($information->article_date)); @endphp</span>
            <h2 class="contents-header-h2 tall" style="margin-bottom:0">{{ $information->title }}</h2>
          </header>
          <div class="links-body">
            {!! nl2br($information->comment) !!}
          </div>

          <div class="talc">
            <a href="/info" class="form-submit-btn mini">記事一覧へ</a>
          </div>
