...
<html>
  ...
  <body>
    <div class="header">
      ...
      <h1 class="header_heading tac" >保育士等キャリアアップ研修【{{ $data['carrerup_certificates']->parent_curriculum }}】修了証</h1>
    </div>
    <div class="content">
      ...
      <div style=" padding-bottom:20px;">
        <table style=" width: 100%;" class="apptbl">
          <tr>
            <th>【修了分野】 </th>
            <td>{{ $data['carrerup_certificates']->parent_curriculum }}</div>
            </td>
          </tr>
          <tr>
            <th>研修実施機関名</th>
    ...
    <div class="footer">
      <p>上記のとおり、保育士等キャリアアップ研修【{{ $data['carrerup_certificates']->parent_curriculum}}】の受講を修了したことを証明します。</p>
      
      <p style=" text-align:right">
      @php
      echo date('Y年m月d日', strtotime($data['carrerup_certificates']->created_at));
      @endphp
      </p>
