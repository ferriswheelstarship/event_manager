...
return [
    ...
    */
    ...
    'TO' => [
        '研修ごとの参加（予定）者','全ユーザ（特権ユーザ含む）','全ユーザ（特権ユーザ除く）','支部ユーザ','法人ユーザ','個人ユーザ','支部+法人ユーザ','支部+個人ユーザ','法人+個人ユーザ',
    ],

    // 更新履歴用（更新項目）
    'UPDATED_ITEM' => [
        'email' => 'メールアドレス', 'name' => '名前', 'ruby' => 'フリガナ', 'phone' => '電話番号', 'fax' => 'FAX' , 'zip' => '郵便番号', 'address' => '住所',
        'area_name' => '地区名', 'branch_name' => '支部名', 'company_variation' => '設置主体', 'public_or_private' => '公・私', 'category' => 'こども園類型', 'kyokai_number' => '協会NO',
    ],
